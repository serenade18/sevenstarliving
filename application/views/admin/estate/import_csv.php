                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <?php echo form_open_multipart(NULL, array('class' => 'form-horizontal import_csv', 'role'=>'form'))?>                              
                        ...
                        <div class="form-group clearfix">
                            <label class="col-lg-2 control-label"><?php echo lang_check('Limit listings')?></label>
                            <div class="col-lg-10">
                                  <?php echo form_input('limit_listings', $this->input->post('limit_listings') ? $this->input->post('limit_listings') : '10', 'class="form-control ui-state-valid"');?>
                            </div>
                        </div>   
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label class="col-lg-2 control-label"><?php echo lang_check('Ajax import')?></label>
                          <div class="col-lg-10">
                          <?php echo form_checkbox('ajax_import', '1', FALSE, 'id="ajax_import"')?>
                          </div>
                        </div>
                        <div class="form-group">
    ...
    $('.import_csv').submit(function(e){
        if($('#ajax_import').prop('checked')) {
            ...
            var import_ajax = function () {
                $.ajax({
                  url: "<?php echo site_url('privateapi/importcsv');?>",
                  data        : php_data,
                  cache       : false,
                  contentType : false,
                  processData : false,
