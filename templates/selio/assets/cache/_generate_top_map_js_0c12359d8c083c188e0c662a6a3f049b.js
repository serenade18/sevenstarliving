...
$(document).ready(function(){
    ...
    if($('#main-map').length){    
        ...
        var positron = L.tileLayer('https://cartodb-basemaps-{s}.global.ssl.fastly.net/light_all/{z}/{x}/{y}{r}.png').addTo(map);
            ...
            marker.bindPopup("<!--Widget-preview-category-path: Land--><div class=\"infobox map-box\">    <a href=\"https://sevenstarliving.co.uk/index.php/property/11/en/sky_apartment\" class=\"listing-img-container\">        <div class=\"infoBox-close\"><i class=\"fa fa-times\"></i>        </div><img src=\"https://sevenstarliving.co.uk/files/strict_cache/575x5005388050721_b84cf3a0a3_b.webp\" alt=\"Sky apartment\">        <div class=\"rate-info\">                    <span class=\"purpose-Sale\">                Sale            </span>         </div>        <div class=\"listing-item-content\">            <h3>Sky apartment</h3>            <span><i class=\"la la-map-marker\"></i>Jerovec 16, Croatia</span>        </div>    </a></div>", jpopup_customOptions);
            clusters.addLayer(marker);
            markers.push(marker);
            ...
            marker.bindPopup("<!--Widget-preview-category-path: House--><div class=\"infobox map-box\">    <a href=\"https://sevenstarliving.co.uk/index.php/property/10/en/lux_apartment\" class=\"listing-img-container\">        <div class=\"infoBox-close\"><i class=\"fa fa-times\"></i>        </div><img src=\"https://sevenstarliving.co.uk/files/strict_cache/575x5005388047921_efc5b357c8_b.webp\" alt=\"Lux apartment\">        <div class=\"rate-info\">                    <span class=\"purpose-Sale\">                Sale            </span>         </div>        <div class=\"listing-item-content\">            <h3>Lux apartment</h3>            <span><i class=\"la la-map-marker\"></i>Cubinec 11, Croatia</span>        </div>    </a></div>", jpopup_customOptions);
            clusters.addLayer(marker);
            markers.push(marker);
