...
$(document).ready(function(){
    ...
    if($('#main-map').length){    
        ...
        var positron = L.tileLayer('https://cartodb-basemaps-{s}.global.ssl.fastly.net/light_all/{z}/{x}/{y}{r}.png').addTo(map);
            ...
            marker.bindPopup("<!--Widget-preview-category-path: --><div class=\"infobox map-box\">    <a href=\"http://sevenstarliving.co.uk/index.php/property/12/hr/retro_kuca\" class=\"listing-img-container\">        <div class=\"infoBox-close\"><i class=\"fa fa-times\"></i>        </div><img src=\"http://sevenstarliving.co.uk/files/strict_cache/575x5005388057701_5a618e8a9e_b.webp\" alt=\"Retro kuća\">        <div class=\"rate-info\">                    <h5>                                                50.000€                                        </h5>                    <span class=\"purpose-Prodaja\">                Prodaja            </span>         </div>        <div class=\"listing-item-content\">            <h3>Retro kuća</h3>            <span><i class=\"la la-map-marker\"></i>Zeleni put 21, Croatia</span>        </div>    </a></div>", jpopup_customOptions);
            clusters.addLayer(marker);
            markers.push(marker);
