...
$similar_estates = $CI->estate_m->get_by($where, FALSE, 4, 'RAND()', 0, array('v_search_option_location'=>$estate_data_address), NULL);
...
<div class="similar-listings-posts">
    <h3><?php echo lang_check('Near properties'); ?></h3>
