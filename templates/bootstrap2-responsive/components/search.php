...
//            });
                ...
                <?php echo sw_get_option_icon(19);?>
                ...
                <label class="checkbox">
                <?php echo sw_get_option_icon(22);?>
                ...
                <label class="checkbox">
                    <?php echo sw_get_option_icon(25);?>
                ...
                <label class="checkbox">
                    <?php echo sw_get_option_icon(27);?>
                ...
                <label class="checkbox">
                    <?php echo sw_get_option_icon(28);?>
                ...
                <label class="checkbox">
                    <?php echo sw_get_option_icon(29);?>
                ...
                <label class="checkbox">
                    <?php echo sw_get_option_icon(32);?>
                ...
                <label class="checkbox">
                    <?php echo sw_get_option_icon(30);?>
                ...
                <label class="checkbox">
                    <?php echo sw_get_option_icon(33);?>
